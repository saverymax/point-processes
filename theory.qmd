...
Remember the PO data. Now let's think about how to model it. The points you collected, they actually can be described with a very specific mathematical structure, called a Nonhomogeneuous Poisson Process (NHPP). I'll describe the mathematical details of it now.
...
To move between the continuous and discrete versions of this likelihood by partitioning $D$ into a grid of $c$ cells and taking the poisson likelihood:
\begin{equation}
\label{eq:pp-l}
